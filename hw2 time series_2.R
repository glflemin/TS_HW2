...
grid(col = "gray80", lty = "dotted", lwd = par("lwd"), equilogs = TRUE)
...
plot(all_data, main = 'Linear/Holt ESM Forecast', ylab='Depth (Ft)')
...
grid(col = "gray80", lty = "dotted",
     lwd = par("lwd"), equilogs = TRUE) #Added gridlines
#abline(v = seq(2008,2017), col = "grey", lty = "dashed")
abline(v = 2018, col = "red", lty = "dashed")
lines(actual, col='red')
